...
setTimeout(() => document.body.classList.remove('png-exporting'), 1500);
      ...
      onclone:(doc)=>{
        ...
        if(clone){
          ...
          if(clone.dataset.designTheme === 'princess-pink'){
            clone.style.backgroundColor='#fff9fc';
            const sidebar=clone.querySelector('.home-sidebar');
            if(sidebar){
              sidebar.style.background='#fff9fc';
              sidebar.style.backgroundColor='#fff9fc';
              sidebar.style.boxShadow='none';
            }
            clone.querySelectorAll('.home-sidebar .side-box, .home-sidebar .side-content, .home-sidebar .sidebar-tags, .home-sidebar .pref-row, .home-sidebar .platform-box').forEach(el=>{
              el.style.background='transparent';
              el.style.backgroundColor='transparent';
              el.style.boxShadow='none';
            });
            clone.querySelectorAll('.home-sidebar .mini-title').forEach(el=>{
              el.style.background='#fdeaf3';
              el.style.backgroundColor='#fdeaf3';
              el.style.border='1px solid #efd6e0';
