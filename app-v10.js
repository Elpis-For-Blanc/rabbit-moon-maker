  ...
  try{
    ...
    const canvas=await window.html2canvas(sheet,{
      ...
      onclone:(doc)=>{
        ...
        if(clone){
          clone.style.setProperty('--theme', getComputedStyle(document.documentElement).getPropertyValue('--theme').trim() || '#e77aa8');
          clone.style.setProperty('--deep', getComputedStyle(document.documentElement).getPropertyValue('--deep').trim() || '#81445f');
          clone.style.setProperty('--soft', getComputedStyle(document.documentElement).getPropertyValue('--soft').trim() || '#f8dce8');
          clone.style.setProperty('--pale', getComputedStyle(document.documentElement).getPropertyValue('--pale').trim() || '#fff5f9');
          clone.style.setProperty('--line', getComputedStyle(document.documentElement).getPropertyValue('--line').trim() || '#efd6e0');
        }
      }
    });
